...
#    using topology data from: cumulus-ansible-beginner-bgp-nclu.dot
...
REPOSITORY="https://github.com/CumulusNetworks/cumulus-ansible-beginner-bgp-nclu"
REPONAME="cumulus-ansible-beginner-bgp-nclu"
