## begin-ansible-training-bgp-nclu
...
![Network Diagram](https://github.com/chronot1995/begin-ansible-training-bgp-nclu/blob/master/documentation/begin-ansible-training-bgp-nclu.png)
...
3. Copy the Git repo to your local machine:
    ...
    ```git clone https://github.com/chronot1995/begin-ansible-training-bgp-nclu```
...
3. Change directories to the following
    ...
    ```begin-ansible-training-bgp-nclu/automation```
...
3. The following command was used to run the Topology Converter within the vx-simulation directory:
    ...
    ```python2 topology_converter.py begin-ansible-training-bgp-nclu.dot -c```
